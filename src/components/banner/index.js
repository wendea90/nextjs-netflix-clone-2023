...
export default function Banner({ medias }) {
    //receives media that will render automatically changing banner
    ...
    return (
        <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12 lg:pl-24">
            ...
            {/* banner play and more info and navigate(router) to watch page by reusablility & watch random movies by (createrandommedia*/}
