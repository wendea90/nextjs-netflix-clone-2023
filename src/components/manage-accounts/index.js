...
export default function ManageAccounts() {
    ...
    //currently movie page redirect b/c the user is autenticated  to current path name  
    ...
    async function handlePinSubmit(value, index) {
        ...
        if (data.success) {
            ...
            //when you sign in with d/t account and push to new account id when d/t account like mire & maki... 
