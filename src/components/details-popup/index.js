...
import { getAllfavorites, getSimilarTVorMovies, getTVorMovieDetailsByID } from "@/src/utils";
            ...
            async function getMediaDetails() {
                ...
                setSimilarMedias(
                    extractSimilarMovies.map((item) => ({
                        ...item,
                        //type if the current info ID means this media info ID is movie so that means we are getting similar movies and similar to tv
